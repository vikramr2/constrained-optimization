...
import common.mincut as mincut
...
class RealizedSubgraph(AbstractGraph):
    ...
    def find_connected_components(self):
        ...
        return [RealizedSubgraph(IntangibleSubgraph(comp, self.index + f'_{i}'), self._graph) for i, comp in enumerate(components) if len(comp) > 1]
